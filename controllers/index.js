...
exports.update = (req, res) => {
    if (req.session.loggedin) {
        connection.query(
            'UPDATE posts SET title = ? , img_url = ? , content = ? WHERE id = ?',
            [req.body.title,req.body.img_url, req.body.content, req.params.id],
            (error, results) => {
                res.redirect('/');
            }
        );
...
exports.new_post = (req, res) => {
    connection.query(
        ...
        [req.body.title,req.body.img_url, req.body.content, req.body.category],
        (error, results) => {
            res.redirect('/');
        }
    );
